...
var _typeof =
    ...
    function(obj$$1) {
      return obj$$1 && typeof Symbol === 'function' &&
              obj$$1.constructor === Symbol && obj$$1 !== Symbol.prototype ?
          'symbol' :
          typeof obj$$1;
    };
  ...
  function AsyncGenerator(gen) {
    ...
    function send(key, arg) {
      return new Promise(function(resolve, reject) {
        var request =
            {key: key, arg: arg, resolve: resolve, reject: reject, next: null};
...
var slicedToArray = function() {
  function sliceIterator(arr$$1, i) {
    ...
    try {
      for (var _i = arr$$1[Symbol.iterator](), _s;
...
function parseJsonLikeObj(source) {
  try {
    var obj$$1 = eval(
        '(' + ast.transform.wrapInFunction('var _; _ = (' + source + ')') +
        ')()');
  } catch (e) {
    return JSON.parse(source);
  }
  return (typeof obj$$1 === 'undefined' ? 'undefined' : _typeof(obj$$1)) !==
          'object' ?
      null :
      obj$$1;
}
...
var loadPackage = function() {
  var _ref =
      asyncToGenerator(regeneratorRuntime.mark(function _callee(system, spec) {
        var mochaEs6;
...
var interactivelyCreatePackage$1 = function() {
  var _ref2 = asyncToGenerator(regeneratorRuntime.mark(function _callee2(
      system, requester) {
    var world, name, guessedAddress, res, baseURL, maybePackageDir, loc, url,
        address;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 16:
            ...
            maybePackageDir =
                lively_resources.resource(baseURL).join(name).asDirectory().url;
            _context2.next = 20;
          ...
          case 26:
            url = lively_resources.resource(loc).asDirectory(),
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 18:
            ...
            //   if (relative.include("..")) {
            //     throw new Error(`The package path ${relative} is not inside
            //     the Lively directory (${URL.root})`)
            //   }
            // }
            ...
            spec.configFile =
                lively_resources.resource(spec.url).join('package.json').url;
          ...
          case 29:
            ...
            system.resourceEnsureExistance(
                spec.configFile,
                '{\n  "name": "' + spec.name + '",\n  "version": "0.1.0"\n}');
...
var interactivelyReloadPackage$1 = function() {
  var _ref4 = asyncToGenerator(
      regeneratorRuntime.mark(function _callee4(system, vmEditor, packageURL) {
        var name, p;
...
var interactivelyUnloadPackage$1 = function() {
  var _ref5 = asyncToGenerator(regeneratorRuntime.mark(function _callee5(
      system, vmEditor, packageURL, world) {
    var p, really;
...
var interactivelyRemovePackage$1 = function() {
  var _ref6 = asyncToGenerator(
      regeneratorRuntime.mark(function _callee6(system, requester, packageURL) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 12:
                ...
                _context6.next = 15;
                return world.confirm(
                    'Also remove directory ' + p.name + ' including ' +
              ...
              case 15:
                ...
                _context6.next = 19;
                return world.confirm(
                    'REALLY *remove* directory ' + p.name +
                    '? No undo possible...');
...
var showExportsAndImportsOf$1 = function() {
  var _ref7 = asyncToGenerator(regeneratorRuntime.mark(function _callee7(
      system, packageAddress) {
    var world = arguments.length > 2 && arguments[2] !== undefined ?
        arguments[2] :
        $world;

    var p, reports, _iteratorNormalCompletion, _didIteratorError,
        _iteratorError, _iterator, _step, mod, importsExports, report;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 20:
            ...
            _context7.next = 23;
            return _context7.t0.importsAndExportsOf.call(
                _context7.t0, _context7.t1, _context7.t2);
          ...
          case 26:
            ...
            world.logError(new Error(
                'Error when getting imports/exports from module ' + mod.name +
                ':\n' + _context7.t3.stack));
            return _context7.abrupt('continue', 37);
          ...
          case 34:
            ...
            if (importsExports.imports.length) {
              ...
              report +=
                  lively_lang.arr
                      .groupByKey(importsExports.imports, 'fromModule')
                      .mapGroups(function(from, imports) {
                        return 'from ' + from + ': ' +
                            imports
                                .map(function(ea) {
                                  return !ea.local && !ea.imported ?
                                      'nothing imported' :
                                      !ea.imported || ea.imported === ea.local ?
                                      ea.local :
                                      ea.imported + ' as ' + ea.local;
                                })
                                .join(', ');
                      })
                      .toArray()
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 4:
            return _context7.abrupt(
                'return',
                _searchForExistingFilesManually(requester, rootURL, p));
...
var _searchForExistingFilesManually = function() {
  var _ref8 = asyncToGenerator(
      regeneratorRuntime.mark(function _callee8(requester, rootURL, p) {
        var choice, result;
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return requester.world().multipleChoicePrompt(
                    'Add Module',
              ...
              case 5:
                ...
                return requester.world().prompt('URL of module?', {
                  input: rootURL,
                  historyId:
                      'lively.vm._searchForExistingFilesManually.url-of-module'
                });
        ...
        switch (_context9.prev = _context9.next) {
          case 0:
            exclude = function exclude(resource$$1) {
              ...
              if ([
                    '.git', 'node_modules', '.optimized-loading-cache',
                    '.module_cache'
                  ].includes(resource$$1.name()))
                return true;
              if (p) {
            ...
            if (world) {
              loadingIndicator = world.showLoadingIndicatorFor(
                  requester, 'Loading existing modules...');
            }

            _context9.next = 5;
            return lively_resources.resource(rootURL).dirList(
                5, {exclude: exclude});
          ...
          case 8:
            ...
            _context9.next = 12;
            return Promise
                .resolve(loadingIndicator && loadingIndicator.remove())
                .then(function() {
                  return requester.world().filterableListPrompt(
                      'What module to load?', candidates,
                      _extends(
                          {filterLabel: 'filter: ', multiselect: true},
                          requester ?
                              {extent: requester.bounds().extent().withY(400)} :
                              {}));
                });
          ...
          case 12:
            ...
            if (!(!answer || answer.status === 'canceled' ||
...
var _createAndLoadModules = function() {
  var _ref10 = asyncToGenerator(regeneratorRuntime.mark(function _callee10(
      system, fullnames) {
    var results, _iteratorNormalCompletion, _didIteratorError, _iteratorError,
        _iterator, _step, fullname;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 7:
            ...
            _context10.next = 11;
            return system.forgetModule(
                fullname, {forgetDeps: false, forgetEnv: false});
...
function shortModuleName$1(system, moduleId, itsPackage) {
  ...
  function relative(name) {
    ...
    try {
      return String(
          new URL(name).relativePathFrom(new URL(system.getConfig().baseURL)));
    } catch (e) {
    }
    return name;
  }
...
var interactivelyChangeModule$1 = function() {
  var _ref = asyncToGenerator(regeneratorRuntime.mark(function _callee(
      system, moduleName, newSource, options) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
var interactivelyReloadModule$1 = function() {
  var _ref2 = asyncToGenerator(regeneratorRuntime.mark(function _callee2(
      system, vmEditor, moduleName) {
    var reloadDeps = arguments.length > 3 && arguments[3] !== undefined ?
        arguments[3] :
        false;
    var resetEnv = arguments.length > 4 && arguments[4] !== undefined ?
        arguments[4] :
        false;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return system.reloadModule(
                moduleName, {reloadDeps: reloadDeps, resetEnv: resetEnv});
...
var interactivelyUnloadModule$1 = function() {
  var _ref3 = asyncToGenerator(
      regeneratorRuntime.mark(function _callee3(system, vmEditor, moduleName) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return system.forgetModule(
                    moduleName, {forgetEnv: true, forgetDeps: true});
...
var interactivelyRemoveModule$1 = function() {
  var _ref4 = asyncToGenerator(
      regeneratorRuntime.mark(function _callee4(system, requester, moduleName) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                _context4.next = 5;
                return requester.world().confirm(
                    'Remove file ' + fullname + '?', {requester: requester});
...
var interactivelyAddModule$1 = function() {
  var _ref5 = asyncToGenerator(regeneratorRuntime.mark(function _callee5(
      system, requester, relatedPackageOrModuleName) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 18:
            ...
            _context5.next = 22;
            return _askForModuleName(
                system, relatedPackageOrModuleName || String(root), world);
...
function modulesInPackage_defaultExclude(res) {
  if ([
        '.git', 'node_modules', '.optimized-loading-cache', '.module_cache'
      ].includes(res.name())) {
    return true;
  }
  return false;
...
var modulesInPackage = function() {
  var _ref11 = asyncToGenerator(regeneratorRuntime.mark(function _callee11(
      system, packageName) {
    var p, res, found, _iteratorNormalCompletion2, _didIteratorError2,
        _iteratorError2, _iterator2, _step2, _ref13, url;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 14:
            ...
            if (url.match(/\.js$/) &&
                system.isModuleLoaded(url, true /*isNormalized*/))
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt(
                'return',
                tester.loadTestModuleAndExtractTestState(file, testsByFile));
...
var runMochaTests$1 = function() {
  var _ref2 = asyncToGenerator(regeneratorRuntime.mark(function _callee2(
      grep, testsByFile, onChange, onError) {
    var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator,
        _step, _ref5, file, _ref6, mocha, mochaRun;
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            mochaRun = function mochaRun(mocha) {
              return new Promise(function(resolve, reject) {
                var files = lively_lang.arr.compact(mocha.suite.suites)
                                .map(function(_ref4) {
                                  var file = _ref4.file;
                                  return file;
                                }),
                ...
                if (!tests || !tests.length)
                  return reject(new Error(
                      'Trying to run tests of ' + files.join(', ') +
                      ' but cannot find them in loaded tests!'));
                mocha.reporter(function Reporter(runner) {
                  ...
                  runner.on('fail', function(test, error) {
                    try {
                      ...
                      (function() {
                        var attachErrorToTest = function attachErrorToTest(
                            test, error, duration) {
                          test.state = 'failed';
                        ...
                        t = tests.find(function(ea) {
                          return ea.fullTitle === test.fullTitle();
                        });

                        if (t)
                          attachErrorToTest(t, error, test.duration);
                        else {
                          // "test" is a hook...
                          parentTests = lively_lang.arr.invoke(
                              test.parent.tests, 'fullTitle');
                          ...
                          tests
                              ...
                              .forEach(function(ea) {
                                return attachErrorToTest(
                                    ea, error, test.duration);
                              });
                        }
          ...
          case 33:
            return _context2.abrupt(
                'return', {mocha: mocha, testsByFile: testsByFile});
...
var AbstractCoreInterface = function() {
  ...
  createClass(AbstractCoreInterface, [
    ...
    },
    {
      ...
      value: function() {
        var _ref3 =
            asyncToGenerator(regeneratorRuntime.mark(function _callee3(name) {
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                    ...
                    case 2:
                      ...
                      return _context3.abrupt(
                          'return', _context3.sent.find(_context3.t0));
    ...
    },
    {
      ...
      value: function() {
        var _ref4 =
            asyncToGenerator(regeneratorRuntime.mark(function _callee4(name) {
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                    ...
                    case 3:
                      ...
                      return _context4.abrupt(
                          'return', _context4.sent.find(_context4.t0));
    ...
    },
    {
      ...
      value: function() {
        var _ref5 =
            asyncToGenerator(regeneratorRuntime.mark(function _callee5(name) {
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
    ...
    },
    {
      ...
      value: function systemConfChange(source) {
        var jso = parseJsonLikeObj(source), exceptions = ['baseURL'];
    ...
    },
    {
      ...
      value: function() {
        var _ref7 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee7(packageURL) {
              return regeneratorRuntime.wrap(function _callee7$(_context7) {
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
    ...
    },
    {
      ...
      value: function() {
        var _ref8 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee8(packageURL) {
              return regeneratorRuntime.wrap(function _callee8$(_context8) {
                while (1) {
                  switch (_context8.prev = _context8.next) {
                    case 0:
    ...
    },
    {
      ...
      value: function() {
        var _ref9 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee9(packageURL) {
              return regeneratorRuntime.wrap(function _callee9$(_context9) {
                while (1) {
                  switch (_context9.prev = _context9.next) {
                    case 0:
    ...
    },
    {
      ...
      value: function() {
        var _ref10 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee10(packageURL) {
              return regeneratorRuntime.wrap(function _callee10$(_context10) {
                while (1) {
                  switch (_context10.prev = _context10.next) {
                    case 0:
    ...
    },
    {
      ...
      value: function() {
        var _ref11 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee11(source, confFile) {
              return regeneratorRuntime.wrap(function _callee11$(_context11) {
                while (1) {
                  switch (_context11.prev = _context11.next) {
                    case 0:
...
var RemoteCoreInterface = function(_AbstractCoreInterfac) {
  ...
  function RemoteCoreInterface() {
    ...
    var _this = possibleConstructorReturn(
        this,
        (RemoteCoreInterface.__proto__ ||
         Object.getPrototypeOf(RemoteCoreInterface))
            .call(this));
  ...
  createClass(RemoteCoreInterface, [
    ...
    },
    {
      ...
      value: function runEvalAndStringify(source, opts) {
        ...
        return this.currentEval = Promise.resolve()
                                      .then(asyncToGenerator(regeneratorRuntime
                                                                                       ...
                                                                                       return _this2
                                                                                           .runEval(
                                                                                               ...
                                                                                               _extends(
                                                                                                   {
                                                                                                     targetModule:
                                                                                                         'lively://remote-lively-system/runEvalAndStringify',
                                                                                                     promiseTimeout:
                                                                                                         30 *
                                                                                                         1000,
                                                                                                     waitForPromise:
    ...
    },
    {
      key: 'dynamicCompletionsForPrefix',
      value: function() {
        var _ref13 = asyncToGenerator(regeneratorRuntime.mark(function _callee13(
            moduleName, prefix, options) {
          ...
          return regeneratorRuntime.wrap(function _callee13$(_context13) {
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  contextFetch = lively_lang.obj.isString(options.context) ?
                      options.context :
                      false;

                  options = lively_lang.obj.dissoc(
                      options, ['systemInterface', 'System', 'context']);
    ...
    },
    {
      ...
      value: function evalWithResource(url, method, arg) {
        return this.runEvalAndStringify(
            ...
            url + '").' + method + '(' + (arg ? JSON.stringify(arg) : '') +
            ');\n    ');
      }
    },
    {
    ...
    },
    {
      ...
      value: function resourceDirList(url, depth, opts) {
        return this.runEvalAndStringify(
            ...
            url + '").dirList(' + JSON.stringify(depth) + ', ' +
            JSON.stringify(opts) + '))\n        .map(({url}) => ({url}))');
      }
    ...
    },
    {
      ...
      value: function livelySystemAccessor() {
        var varName = arguments.length > 0 && arguments[0] !== undefined ?
            arguments[0] :
            'livelySystem';

        return 'var ' + varName +
            ' = (typeof lively !== "undefined" && lively.systemInterface)\n      || System.get(System.decanonicalize("lively-system-interface"))\n      || (typeof lively !== "undefined" && lively.modules && await lively.modules.importPackage("lively-system-interface"));\n    if (!' +
            varName +
            ') throw new Error("lively-system-interface not available!");';
      }
    },
    {
      key: 'normalizeSync',
      value: function normalizeSync(name, parentName, isPlugin) {
        return this.runEvalAndStringify(
            'lively.modules.System.decanonicalize(' + JSON.stringify(name) +
            ', ' + JSON.stringify(parentName) + ', ' + isPlugin + ')');
      }
    },
    {
      key: 'normalize',
      value: function normalize(name, parent, parentAddress) {
        return this.runEvalAndStringify(
            'lively.modules.System.normalize(' + JSON.stringify(name) + ', ' +
            JSON.stringify(parent) + ', ' + JSON.stringify(parentAddress) +
            ')');
      }
    },
    {
    ...
    },
    {
      ...
      value: function getConfig() {
        return this.runEvalAndStringify(
            'var c = Object.assign({}, lively.modules.System.getConfig()); for (var name in c) if (name.indexOf("__lively.modules__") === 0 || name.indexOf("loads") === 0) delete c[name]; c');
      }
    },
    {
      key: 'setConfig',
      value: function setConfig(conf) {
        return this.runEvalAndStringify(
            'lively.modules.System.config(' + JSON.stringify(conf) + ')');
      }
    },
    {
      key: 'getPackages',
    ...
    },
    {
      ...
      value: function isModuleLoaded(name, isNormalized) {
        return this.runEvalAndStringify(
            'lively.modules.isModuleLoaded("' + name + '", ' + isNormalized +
            ')');
      }
    },
    {
      ...
      value: function doesModuleExist(name, isNormalized) {
        return this.runEvalAndStringify(
            'lively.modules.doesModuleExist("' + name + '", ' + isNormalized +
            ')');
      }
    },
    {
      ...
      value: function() {
        var _ref14 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee14(packageURL) {
                  ...
                  switch (_context14.prev = _context14.next) {
                    case 0:
                      return _context14.abrupt(
                          'return',
                          this.runEvalAndStringify(
                              'lively.modules.registerPackage(' +
                              JSON.stringify(packageURL) + ')'));
    ...
    },
    {
      ...
      value: function() {
        var _ref15 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee15(packageURL) {
    ...
    },
    {
      ...
      value: function() {
        var _ref16 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee16(packageURL) {
    ...
    },
    {
      ...
      value: function() {
        var _ref17 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee17(packageURL, opts) {
    ...
    },
    {
      ...
      value: function packageConfChange(source, confFile) {
        return this.runEvalAndStringify(
            '\n      ' + this.livelySystemAccessor() +
            ';\n      await livelySystem.localInterface.packageConfChange(' +
            JSON.stringify(source) + ', ' + JSON.stringify(confFile) + ')');
      }
    },
    {
      key: 'resourcesOfPackage',
      value: function() {
        var _ref18 = asyncToGenerator(regeneratorRuntime.mark(function _callee18(
            packageOrAddress) {
          var exclude = arguments.length > 1 && arguments[1] !== undefined ?
              arguments[1] :
              [
                '.git', 'node_modules', '.module_cache',
          ...
          return regeneratorRuntime.wrap(function _callee18$(_context18) {
            while (1) {
              switch (_context18.prev = _context18.next) {
                case 0:
                  if (packageOrAddress.address)
                    packageOrAddress = packageOrAddress.address;
                  return _context18.abrupt(
                      'return',
                      this.runEvalAndStringify(
                          '\n      ' + this.livelySystemAccessor() +
                          ';\n      await livelySystem.localInterface.resourcesOfPackage(' +
                          JSON.stringify(packageOrAddress) + ', ' +
    ...
    },
    {
      ...
      value: function() {
        var _ref19 =
            asyncToGenerator(regeneratorRuntime.mark(function _callee19(name) {
              var spec;
    ...
    },
    {
      ...
      value: function importModule(name) {
        return this.runEvalAndStringify(
            'lively.modules.System.import(' + JSON.stringify(name) + ')');
      }
    },
    {
      key: 'forgetModule',
      value: function forgetModule(name, opts) {
        return this.runEvalAndStringify(
            'lively.modules.module(' + JSON.stringify(name) + ').unload(' +
            JSON.stringify(opts) + ')');
      }
    },
    {
      ...
      value: function reloadModule(name, opts) {
        return this.runEvalAndStringify(
            'lively.modules.module(' + JSON.stringify(name) + ').reload(' +
            JSON.stringify(opts) + ')');
      }
    },
    {
      ...
      value: function moduleFormat(moduleName) {
        return this.runEvalAndStringify(
            'lively.modules.module(' + JSON.stringify(moduleName) +
            ').format();');
      }
    },
    {
    ...
    },
    {
      ...
      value: function moduleSourceChange(moduleName, newSource, options) {
        return this.runEvalAndStringify(
            'lively.modules.module(' + JSON.stringify(moduleName) +
            ').changeSource(' + JSON.stringify(newSource) + ', ' +
    ...
    },
    {
      ...
      value: function keyValueListOfVariablesInModule(moduleName, sourceOrAst) {
        return this.runEvalAndStringify(
            ...
            JSON.stringify(moduleName) + ', ' + JSON.stringify(sourceOrAst) +
            ')');
      }
    ...
    },
    {
      ...
      value: function importsAndExportsOf(modId, sourceOrAst) {
        return this.runEvalAndStringify(
            '({\n      imports: await lively.modules.module(' +
            JSON.stringify(modId) +
            ').imports(),\n      exports: await lively.modules.module(' +
            JSON.stringify(modId) + ').exports()})');
      }
    },
    {
      ...
      value: function exportsOfModules(options) {
        return this.runEvalAndStringify(
            ...
            options.excludedPackages
                .map(function(k) {
                  return typeof k === 'function' ? k.toString() :
                                                   JSON.stringify(k);
                })
                .join(',') +
    ...
    },
    {
      ...
      value: function searchInPackage(packageURL, searchString, options) {
        return this.runEvalAndStringify(
            '\n      ' + this.livelySystemAccessor() +
            ';\n      await livelySystem.localInterface.searchInPackage(' +
            JSON.stringify(packageURL) + ', ' + JSON.stringify(searchString) +
            ', ' + JSON.stringify(options) + ')');
      }
    ...
    },
    {
      ...
      value: function() {
        var _ref20 = asyncToGenerator(regeneratorRuntime.mark(function _callee20(
            file) {
          var testsByFile = arguments.length > 1 && arguments[1] !== undefined ?
              arguments[1] :
              [];
              ...
              switch (_context20.prev = _context20.next) {
                case 0:
                  return _context20.abrupt(
                      ...
                      this.runEvalAndStringify(
                          '\n      ' + this.livelySystemAccessor() +
                          ';\n      var {testsByFile} = await livelySystem.localInterface.loadMochaTestFile(' +
                          JSON.stringify(file) + ', ' +
                          JSON.stringify(testsByFile) +
                          '), result;\n      result = {testsByFile}'));
    ...
    },
    {
      key: 'runMochaTests',
      value: function() {
        var _ref21 = asyncToGenerator(regeneratorRuntime.mark(function
                                                                  _callee21(
                                                                      grep,
                                                                      testsByFile,
                                                                      onChange,
                                                                                    ...
                                                                                    return _context21
                                                                                        .abrupt(
                                                                                            ...
                                                                                            this.runEvalAndStringify(
                                                                                                ...
                                                                                                this.livelySystemAccessor() +
                                                                                                ';\n      var {testsByFile, isError, value: error} = await livelySystem.localInterface.runMochaTests(grep, ' +
                                                                                                JSON.stringify(
                                                                                                    testsByFile ||
                                                                                                    [
                                                                                                    ]) +
...
var LocalCoreInterface = function(_AbstractCoreInterfac) {
  ...
  function LocalCoreInterface() {
    ...
    return possibleConstructorReturn(
        this,
        (LocalCoreInterface.__proto__ ||
         Object.getPrototypeOf(LocalCoreInterface))
  ...
  createClass(LocalCoreInterface, [
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  return vm.completions.getCompletions(function(code) {
                    return vm.runEval(
                        code, _extends({targetModule: moduleName}, options));
                  }, prefix);
    ...
    },
    {
      ...
      value: function getPackages(options) {
        ...
        excludedURLs = excludedURLs.concat(excludedURLs.map(function(url) {
          return System.decanonicalize(url.replace(/\/?$/, '/'))
              .replace(/\/$/, '');
        }));
        return modules.getPackages().filter(function(p) {
          return !excludedURLs.includes(p.url) &&
              !excludeFns.some(function(fn) {
                return fn(p.url);
              });
        });
      }
    ...
    },
    {
      ...
      value: function() {
        var _ref2 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee2(packageURL) {
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
    ...
    },
    {
      ...
      value: function() {
        var _ref3 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee3(packageURL) {
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
    ...
    },
    {
      ...
      value: function() {
        var _ref4 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee4(packageURL) {
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
    ...
    },
    {
      ...
      value: function() {
        var _ref5 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee5(packageURL, opts) {
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
        ...
        var _ref6 = asyncToGenerator(regeneratorRuntime.mark(function _callee6(
          ...
          return regeneratorRuntime.wrap(function _callee6$(_context6) {
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  S = modules.System, config = parseJsonLikeObj(source),
                  newSource = JSON.stringify(config, null, 2);
                  _context6.next = 3;
                  return modules.module(confFile).changeSource(
                      newSource, {doEval: false});

                case 3:
                  S.set(
                      confFile,
                      S.newModule(config));  // FIXME, do this in lively.modules
    ...
    },
    {
      ...
      value: function() {
        var _ref7 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee7(packageOrAddress) {
              var exclude = arguments.length > 1 && arguments[1] !== undefined ?
                  arguments[1] :
                  ['.git', 'node_modules', '.module_cache'];
              var url, p;
              return regeneratorRuntime.wrap(function _callee7$(_context7) {
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      _context7.prev = 0;
                      url = packageOrAddress.address ?
                          packageOrAddress.address :
                          packageOrAddress,
                    ...
                    case 4:
                      ...
                      return _context7.abrupt(
                          'return', _context7.sent.map(_context7.t0));
                    ...
                    case 8:
                      ...
                      console.warn(
                          'resourcesOfPackage error for ' + packageOrAddress +
                          ': ' + _context7.t1);
    ...
    },
    {
      ...
      value: function() {
        var _ref8 = asyncToGenerator(regeneratorRuntime.mark(function _callee8(
            moduleName, sourceOrAstOrNothing) {
          var parsed, id, format, scope, importsExports, toplevel, decls,
              imports, col1Width;
          return regeneratorRuntime.wrap(function _callee8$(_context8) {
            while (1) {
              switch (_context8.prev = _context8.next) {
                ...
                case 4:
                  parsed = typeof sourceOrAstOrNothing === 'string' ?
                ...
                case 10:
                  ...
                  decls = lively_lang.arr.sortByKey(
                      ast.query.declarationsOfScope(toplevel.scope, true),
                      'start');
                  imports = lively_lang.arr.pluck(
                      toplevel.scope.importSpecifiers, 'name');
                  col1Width = 0;
                      ...
                      decls
                          .map(function(v) {
                            var nameLength = v.name.length,
                                isExport =
                                    importsExports.exports.find(function(ea) {
                                      return ea.local === v.name;
                                    }),
                                isImport =
                                    lively_lang.arr.include(imports, v.name);
                            ...
                            return {
                              ...
                              printedValue:
                                  lively_lang.obj
                                      .inspect(scope[v.name], {maxDepth: 1})
                                      .replace(/\n/g, '')
                            };
                          })
                          .map(function(val) {
                            return {
                              isListItem: true,
                              value: val,
                              string: val.printedName +
                                  lively_lang.string.indent(
                                      ' = ' + val.printedValue, ' ',
                                      col1Width - val.printedName.length)
                            };
                          }));
              ...
              switch (_context9.prev = _context9.next) {
                ...
                case 5:
                  ...
                  return _context9.abrupt(
                      'return', {imports: _context9.t0, exports: _context9.t1});
...
var HTTPCoreInterface = function(_RemoteCoreInterface) {
  ...
  function HTTPCoreInterface(url) {
    ...
    var _this = possibleConstructorReturn(
        this,
        (HTTPCoreInterface.__proto__ ||
         Object.getPrototypeOf(HTTPCoreInterface))
            .call(this));
...
var L2LCoreInterface = function(_RemoteCoreInterface) {
  ...
  function L2LCoreInterface(targetId, peer) {
    ...
    var _this = possibleConstructorReturn(
        this,
        (L2LCoreInterface.__proto__ || Object.getPrototypeOf(L2LCoreInterface))
            .call(this));
  ...
  createClass(L2LCoreInterface, [
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 4:
                  ...
                  clients = _ref2.data;
                  return _context.abrupt(
                      'return', clients.some(function(_ref3) {
                        var _ref4 = slicedToArray(_ref3, 1), id = _ref4[0];
    ...
    },
    {
      ...
      value: function() {
        var _ref5 = asyncToGenerator(
            regeneratorRuntime.mark(function _callee2(source, options) {
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      throw new Error(
                          'No lively.2lively default client available!');

                    case 3:
                      l2lEval = new vm.evalStrategies.L2LEvalStrategy(
                          l2lClient, this.targetId);
                      return _context2.abrupt(
    ...
    },
    {
      key: 'description',
      get: function get() {
        var targetId = this.targetId, peer = this.peer,
            id = targetId.slice(0, 5), name = 'l2l ' + id;

        if (peer) {
          var location = peer.location, type = peer.type, user = peer.user,
              world = peer.world;
    ...
    },
    {
      key: 'client',
      get: function get() {
        var _ref6 = lively.modules.module('lively.2lively/client.js').get() ||
  ...
  createClass(Interface, [
    {
      ...
      value: function dynamicCompletionsForPrefix(mod, prefix, opts) {
        return this.coreInterface.dynamicCompletionsForPrefix(
            mod, prefix, opts);
      }
    },
    {
    ...
    },
    {
      key: 'keyValueListOfVariablesInModule',
      value: function keyValueListOfVariablesInModule(moduleName, sourceOrAst) {
        return this.coreInterface.keyValueListOfVariablesInModule(
            moduleName, sourceOrAst);
      }
    },
    {
    ...
    },
    {
      ...
      value: function interactivelyUnloadPackage(vmEditor, packageURL, world) {
        return interactivelyUnloadPackage$1(
            this.coreInterface, vmEditor, packageURL, world);
      }
    },
    {
      key: 'interactivelyRemovePackage',
      value: function interactivelyRemovePackage(requester, pkgURL) {
        return interactivelyRemovePackage$1(
            this.coreInterface, requester, pkgURL);
      }
    },
    {
      key: 'isModuleLoaded',
    ...
    },
    {
      ...
      value: function interactivelyChangeModule(
          moduleName, newSource, options) {
        return interactivelyChangeModule$1(
            this.coreInterface, moduleName, newSource, options);
      }
    },
    {
      key: 'interactivelyReloadModule',
      value: function interactivelyReloadModule(vmEditor, moduleName) {
        return interactivelyReloadModule$1(
            this.coreInterface, vmEditor, moduleName);
      }
    },
    {
      key: 'interactivelyUnloadModule',
      value: function interactivelyUnloadModule(vmEditor, moduleName) {
        return interactivelyUnloadModule$1(
            this.coreInterface, vmEditor, moduleName);
      }
    },
    {
      ...
      value: function interactivelyRemoveModule(requester, moduleName) {
        return interactivelyRemoveModule$1(
            this.coreInterface, requester, moduleName);
      }
    },
    {
      key: 'interactivelyAddModule',
      value: function interactivelyAddModule(
          requester, relatedPackageOrModule) {
        return interactivelyAddModule$1(
            this.coreInterface, requester, relatedPackageOrModule);
      }
    },
    {
      key: 'showExportsAndImportsOf',
      value: function showExportsAndImportsOf(packageAddress, world) {
        return showExportsAndImportsOf$1(
            this.coreInterface, packageAddress, world);
      }
    },
    {
      key: 'exportsOfModules',
    ...
    },
    {
      ...
      value: function searchInPackage(packageURL, searchTerm, options) {
        return this.coreInterface.searchInPackage(
            packageURL, searchTerm, options);
      }
    },
    {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 12:
                      pm &&
                          pm.step(
                              url.replace(System.baseURL, '').slice(0, 20),
                              .1 + .9 * (i / packages.length));
                      _context.prev = 13;
                      _context.next = 16;
                      return this.coreInterface.searchInPackage(
                          url, searchTerm, options);
                    ...
                    case 20:
                      ...
                      console.error(
                          'Error searching in package ' + url + ':\n' +
                          _context.t0.stack);
...
var serverInterfaceFor = function serverInterfaceFor(url) {
  return httpInterfaces[url] ||
      (httpInterfaces[url] = new Interface(new HTTPCoreInterface(url)));
};
var l2lInterfaces = {};
var l2lInterfaceFor = function l2lInterfaceFor(targetId, peer) {
  return l2lInterfaces[targetId] ||
      (l2lInterfaces[targetId] =
           new Interface(new L2LCoreInterface(targetId, peer)));
};
...
}((this.lively.systemInterface = this.lively.systemInterface || {}), lively.ast,
  lively.lang, lively.resources, lively.modules, lively.vm));
